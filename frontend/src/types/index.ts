...
export interface ChatResponse { answer: string; sections: ResponseSection[]; sources: SourceReference[]; safety_notice: string | null; mode: 'demo' | 'connected'; disclaimer: string; response_kind?: 'direct' | 'researched' | 'clarification'; research_trace?: ResearchTraceEvent[]; research_summary?: ResearchSummary }
